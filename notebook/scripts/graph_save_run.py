...
def compute_infected_hectares_return_farms(state,t, prop_size, D, save_dict):
    ...
    return new_dict, infected_farms
...
reference for months associated with seasons
    ...
    aut_months = ["03","04","05"]
    spr_months = ["06","07","08"]
    wint_months = ["09","10","11"]
"""
"""
    deltaT = 1 or 3 or 12
    init_seed = amount to initialize seed at start
"""
def run_save_si_model (in_bond, out_bond, prop_size, b_b, b_w, D, seeds, T, max_infected,deltaT,min_inc,alpha,F,init_month=2):

    s_name = ["SM","AT","SP","WT"]
    days = {1:31,2:28,3:31,4:30,5:31,6:30,7:31,8:31,9:30,10:31,11:30,12:31}
    season = {1:"SM",2:"SM",3:"AT",4:"AT",5:"AT",6:"WT",7:"WT",8:"WT",9:"SP",10:"SP",11:"SP",12:"SM"}
    ...
    if deltaT == 12:
        folder = "../params/"
        tau_string = "horticulture365_check_NZ.csv"
        file_ending = ""
        tau = 365
    ...
    new_dict = {}
    save_dict, infected_farms = compute_infected_hectares_return_farms(state,t, prop_size, D,new_dict)
    ...
    while (t) < T and infected_farms < max_infected:
        ...
        new_dict, infected_farms = compute_infected_hectares_return_farms(new_state,t, prop_size, D,save_dict)
        state = copy.deepcopy(new_state)
        new_state = {}
        save_dict = copy.deepcopy(new_dict)
        del new_dict
