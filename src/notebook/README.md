...
Notebooks
---------
- **fig_graph_configs.ipynb** visualizes the lines of best fit using the data from the results/ folder
- **create_ma.ipynb** creates the 2-month moving average data from the raw-data 
